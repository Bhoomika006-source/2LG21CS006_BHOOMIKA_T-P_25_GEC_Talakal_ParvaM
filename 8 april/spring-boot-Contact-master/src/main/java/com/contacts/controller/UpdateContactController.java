...
public class UpdateContactController {
	...
	public String updateForm(
			@Valid @ModelAttribute("multiform") Multiform multiform, BindingResult vResult, Model model,
		...
		Contact c = contactRepository.findByUseridandContactId((Long) httpSession.getAttribute("uid"),
				multiform.getContactId());
		System.out.println("Phone Listing");
		List<ContactPhone> phList = contactPhoneRepository
				.findByUseridandContactId((Long) httpSession.getAttribute("uid"), multiform.getContactId());
